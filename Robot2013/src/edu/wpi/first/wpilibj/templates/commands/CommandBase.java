...
public abstract class CommandBase extends Command {
    ...
    public static Climber leftArm = new Climber(RobotMap.leftArmEncoderA, RobotMap.leftArmEncoderB, RobotMap.leftArmJag);
    public static Climber rightArm = new Climber(RobotMap.rightArmEncoderA, RobotMap.rightArmEncoderB, RobotMap.rightArmJag);
