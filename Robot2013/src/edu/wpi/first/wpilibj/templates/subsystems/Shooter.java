...
public class Shooter extends PIDSubsystem {
    ...
    public Shooter() {
        ...
        shooterEncoder = new Encoder(RobotMap.shooterEncoderA, RobotMap.shooterEncoderB,false,Encoder.EncodingType.k1X);
        ...
        //conversion factor for pulses/sec to revolutions/minute
...
//        vic3.set(output);
    ...
    {
        SmartDashboard.putNumber("ShooterRPM",shooterEncoder.getRate() * 60);
